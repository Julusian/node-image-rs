...
switch (platform) {
  case "android":
    switch (arch) {
      case "arm64":
        try {
          nativeBinding = runtimeRequire(
            "julusian-image-rs.android-arm64.node"
          );
        } catch (e) {
          loadError = e;
        }
      ...
      case "arm":
        try {
          nativeBinding = runtimeRequire(
            "julusian-image-rs.android-arm-eabi.node"
          );
        } catch (e) {
          loadError = e;
        }
  ...
  case "win32":
    switch (arch) {
      case "x64":
        try {
          nativeBinding = runtimeRequire(
            "julusian-image-rs.win32-x64-msvc.node"
          );
        } catch (e) {
          loadError = e;
        }
      ...
      case "ia32":
        try {
          nativeBinding = runtimeRequire(
            "julusian-image-rs.win32-ia32-msvc.node"
          );
        } catch (e) {
          loadError = e;
        }
      ...
      case "arm64":
        try {
          nativeBinding = runtimeRequire(
            "julusian-image-rs.win32-arm64-msvc.node"
          );
        } catch (e) {
          loadError = e;
        }
    ...
    switch (arch) {
      case "x64":
        if (isMusl()) {
          try {
            nativeBinding = runtimeRequire(
              "julusian-image-rs.linux-x64-musl.node"
            );
          } catch (e) {
            loadError = e;
          }
          ...
          try {
            nativeBinding = runtimeRequire(
              "julusian-image-rs.linux-x64-gnu.node"
            );
          } catch (e) {
            loadError = e;
          }
      ...
      case "arm64":
        if (isMusl()) {
          try {
            nativeBinding = runtimeRequire(
              "julusian-image-rs.linux-arm64-musl.node"
            );
          } catch (e) {
            loadError = e;
          }
          ...
          try {
            nativeBinding = runtimeRequire(
              "julusian-image-rs.linux-arm64-gnu.node"
            );
          } catch (e) {
            loadError = e;
          }
      ...
      case "arm":
        try {
          nativeBinding = runtimeRequire(
            "julusian-image-rs.linux-arm-gnueabihf.node"
          );
        } catch (e) {
          loadError = e;
        }
